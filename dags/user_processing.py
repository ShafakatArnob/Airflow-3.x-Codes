...
#     fake_user = ti.xcom_pull(task_ids="is_api_available")  # ti is reserved keyword for Task Instance, it has the xcom values of every tasks in it.
#     # import requests
...
def user_processing():
    ...
    def store_user():
        ...
        hook.copy_expert(                                 # copy_expert is used to copy data from a file to a table
